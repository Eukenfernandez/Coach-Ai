...
export const VIDEO_CONTEXT_SCHEMA = {
...
export const VIDEO_ANSWER_SCHEMA = {
    type: SchemaType.OBJECT,
    properties: {
...
export const buildVideoContextProcessingPrompt = ({ language, sport, discipline, metadata, segments, }) => `
...
`;
export const buildVideoQuestionPrompt = ({ language, sport, discipline, question, currentTimeSeconds, mode, retrievalPayload, history, processingStatus, }) => `
