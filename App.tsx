  ...
  return (
    <div className="flex h-[100dvh] w-full bg-neutral-950 text-white overflow-hidden relative">
      ...
      <main className="flex-1 h-full overflow-hidden relative flex flex-col">
        ...
        {currentScreen === "analyzer" && selectedVideo && <VideoAnalyzer video={selectedVideo} onBack={() => navigateTo("gallery")} usage={displayedUsage} limits={userLimits} onIncrementUsage={handleIncrementChat} language={language} />}
